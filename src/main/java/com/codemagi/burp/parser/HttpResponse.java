...
/**
 * Generic http response parser. Messages
 ...
 * ...
 * </pre>
 * where status_line is something like
 * <pre>HTTP/1.1 200 OK</pre>
 *
 * <p>This class will parse all the header/value pairs and store
 * them in a ({@link java.util.LinkedHashMap}),
 * and parse the first line as 'command'. The
 * <tt>LinkedHashMap</tt> will assure that an iterator will visit the
 * fields in the order they were originally sent/parsed.
 *
	...
	private void parse(InputStream in) throws IOException {
		...
		if (currLine != null) {
			while (currLine != null) {
				...
				currLine = bin.readLine();
				if (currLine != null) bodyBuilder.append("\n");
			}
		}
